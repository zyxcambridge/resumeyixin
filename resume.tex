...
% Chinese font setup - using system fonts available on macOS
% Use Heiti SC which is available on macOS
...
\textbf{VLN部署算法工程师} | 某上市公司机器人子公司 | 2025.2 - 至今
...
\begin{itemize}[leftmargin=*,itemsep=2pt,parsep=1pt]
    ...
    \item \textbf{模型部署与优化：}
    \begin{itemize}[leftmargin=*,noitemsep]
        \item 在NVIDIA Thor平台上成功部署VLN模型，实现端到端推理优化
...
\begin{itemize}[leftmargin=*,itemsep=2pt,parsep=1pt]
    ...
    \item 参与NeurIPS 2025智能体工具增强推理Workshop，调用FDA、OpenTargets、PubMed等生物医学工具
