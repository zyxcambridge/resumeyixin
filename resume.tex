...
\begin{itemize}[leftmargin=*,itemsep=2pt,parsep=1pt]
    ...
    \item \textbf{项目背景：} 参与NeurIPS 2025顶级会议Workshop，构建生物医学领域专业Agent系统
...
\textbf{【项目名称：NeurIPS 2025 CureBench医药Agent系统】}

\vspace{4pt}
\begin{itemize}[leftmargin=*,itemsep=2pt,parsep=1pt]
    \item \textbf{项目角色：} NeurIPS 2025 Workshop项目负责人/核心开发者
    \item \textbf{项目背景：} 参与NeurIPS 2025顶级会议Workshop，构建生物医学领域专业Agent系统。利用Agent和Test-time Scaling技术构建用药助手智能体。
    \item \textbf{技术架构：} CureBench + TxAgent RL Framework - ART Training
    \item \textbf{核心技术：}
    \begin{itemize}[leftmargin=*,noitemsep]
        \item 调用FDA、OpenTargets、PubMed等生物医学工具进行智能体工具增强推理
