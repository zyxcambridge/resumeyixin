...
% 定制化简历 - AGI岗位申请
% 公司: Microsoft
% 职位: Principal Software Engineer - Copilot
% URL: https://careers.microsoft.com/professionals/us/en/search-results?keywords=Copilot
% 地点: Redmond, WA / San Francisco, CA
% 生成时间: 2026-01-04 16:16:06
% 
% 岗位关键词: Copilot, LLM, AI Assistant, Azure, Developer Tools
% 匹配分数: 1
% 匹配优势:
% - 
CureAgent framework, Executor-Analyst architecture, tool-augmented reasoning% - Deployed Ollama, llama.cpp, vllm, TensorRT-LLM, mlc-llm
% ============================================
