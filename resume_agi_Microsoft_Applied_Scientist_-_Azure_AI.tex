...
% 
% 岗位关键词: Azure AI, Model Training, NLP, Computer Vision, Distributed Training
% 匹配分数: 1
% 匹配优势:
% - 
Deployed on Thor, Orin, Jetson platforms with 4x latency reduction% - Quantization (PTQ/QAT), operator fusion, multi-task scheduling
% ============================================
