...
% 地点: Shanghai, China / Santa Clara, CA
% 生成时间: 2026-01-04 16:16:06
% 
% 岗位关键词: AI Agent, Multi-Agent, Autonomous Vehicle, PyTorch, CUDA, LLM, Distributed Systems
% 匹配分数: 6
% 匹配优势:
% - 
NeurIPS 2025 CureBench Global 2nd Place - AI Agent development% - CureAgent framework, Executor-Analyst architecture, tool-augmented reasoning% - Deployed on Thor, Orin, Jetson platforms with 4x latency reduction% - Quantization (PTQ/QAT), operator fusion, multi-task scheduling% - Deployed Ollama, llama.cpp, vllm, TensorRT-LLM, mlc-llm
% ============================================
