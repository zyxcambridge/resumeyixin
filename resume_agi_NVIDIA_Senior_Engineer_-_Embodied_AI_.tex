...
% 定制化简历 - AGI岗位申请
% 公司: NVIDIA
% 职位: Senior Engineer - Embodied AI / Robotics
% URL: https://nvidia.wd5.myworkdayjobs.com/en-US/NVIDIAExternalCareerSite/jobs
% 地点: Shanghai, China / Seattle, WA
% 生成时间: 2026-01-04 16:16:06
% 
% 岗位关键词: Embodied AI, Robotics, Vision-Language, Reinforcement Learning, Isaac Sim, VLN
% 匹配分数: 4
% 匹配优势:
% - 
VLN deployment, 150m long-range navigation, zero-shot generalization% - CureAgent framework, Executor-Analyst architecture, tool-augmented reasoning
% ============================================
