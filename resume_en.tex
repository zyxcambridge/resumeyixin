...
\begin{itemize}[leftmargin=*,itemsep=2pt,parsep=1pt]
    ...
    \item \textbf{Project Background:} Participated in NeurIPS 2025 top-tier conference Workshop, building professional Agent system in biomedical field
...
\textbf{[Project: NeurIPS 2025 CureBench Medical Agent System]}

\vspace{4pt}
\begin{itemize}[leftmargin=*,itemsep=2pt,parsep=1pt]
    \item \textbf{Project Role:} NeurIPS 2025 Workshop Project Lead / Core Developer
    \item \textbf{Project Background:} Participated in NeurIPS 2025 top-tier conference Workshop, built professional Agent system in biomedical field. Utilized Agent and Test-time Scaling technologies to build medication assistant agent.
    \item \textbf{Technical Architecture:} CureBench + TxAgent RL Framework - ART Training
    ...
    \begin{itemize}[leftmargin=*,noitemsep]
        ...
        \item Successfully built practical biomedical field agent system
    \end{itemize}
\end{itemize}
