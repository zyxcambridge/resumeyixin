...
% 定制化简历 - AGI岗位申请
% 公司: Google DeepMind
% 职位: Research Engineer - Gemini
% URL: https://careers.google.com/jobs/results/?q=Gemini
% 地点: Mountain View, CA / London, UK
% 生成时间: 2026-01-04 16:16:06
% 
% 岗位关键词: Gemini, Multimodal, Foundation Model, JAX, Distributed Systems, NLP
% 匹配分数: 2
% 匹配优势:
% - 
Deployed Ollama, llama.cpp, vllm, TensorRT-LLM, mlc-llm% - CureAgent framework, Executor-Analyst architecture, tool-augmented reasoning% - Deployed on Thor, Orin, Jetson platforms with 4x latency reduction% - Quantization (PTQ/QAT), operator fusion, multi-task scheduling
% ============================================
