...
% 定制化简历 - AGI岗位申请
% 公司: NVIDIA
% 职位: Developer Technology Engineer - AI
...
% 
% 岗位关键词: Deep Learning, Machine Learning, GPU, CUDA, LLM, Transformer, TensorRT
% 匹配分数: 3
% 匹配优势:
% - 
Deployed on Thor, Orin, Jetson platforms with 4x latency reduction% - Quantization (PTQ/QAT), operator fusion, multi-task scheduling% - CureAgent framework, Executor-Analyst architecture, tool-augmented reasoning% - Deployed Ollama, llama.cpp, vllm, TensorRT-LLM, mlc-llm
% ============================================
