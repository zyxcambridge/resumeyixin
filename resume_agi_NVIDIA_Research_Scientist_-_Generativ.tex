...
% 定制化简历 - AGI岗位申请
% 公司: NVIDIA
% 职位: Research Scientist - Generative AI
% URL: https://nvidia.wd5.myworkdayjobs.com/en-US/NVIDIAExternalCareerSite/jobs
% 地点: Santa Clara, CA / Remote
% 生成时间: 2026-01-04 16:16:06
% 
% 岗位关键词: Generative AI, Foundation Model, Research, PyTorch, Distributed Training, NeurIPS
% 匹配分数: 6
% 匹配优势:
% - 
Deployed Ollama, llama.cpp, vllm, TensorRT-LLM, mlc-llm% - CureAgent framework, Executor-Analyst architecture, tool-augmented reasoning% - Paper published (arXiv:2512.05576), book in publication% - NeurIPS 2025 CureBench Global 2nd Place - AI Agent development% - Deployed on Thor, Orin, Jetson platforms with 4x latency reduction
% ============================================
