...
% 定制化简历 - AGI岗位申请
% 公司: Microsoft
% 职位: Senior Research Scientist - AI Frontiers
% URL: https://careers.microsoft.com/professionals/us/en/search-results?keywords=AGI
% 地点: Redmond, WA / Remote
% 生成时间: 2026-01-04 16:16:06
% 
% 岗位关键词: AGI, Research, LLM, Foundation Model, NeurIPS, Microsoft Research
% 匹配分数: 5
% 匹配优势:
% - 
Paper published (arXiv:2512.05576), book in publication% - NeurIPS 2025 CureBench Global 2nd Place - AI Agent development% - CureAgent framework, Executor-Analyst architecture, tool-augmented reasoning% - Deployed Ollama, llama.cpp, vllm, TensorRT-LLM, mlc-llm
% ============================================
